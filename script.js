...
'W recyklingu przodują Szwedzi, doskonale sobie radzą z przetwarzaniem odpadów. Dziś jedynie 3% odpadów w tym skandynawskim kraju trafia na wysypiska, reszta jest efektywnie wykorzystywana',
...
'W mieście Kanton w Chinach są nakładane ogromne kary pieniężne, jeśli człowiek w ciągu dnia wyprodukuje więcej niż 1kg śmieci dziennie',
...
function pickRandomItem() {
    ...
    if (userInput >= 1 && userInput <= 10) {
        ...
        document.getElementById('result').textContent = 'Proszę podaj numer od 1 do 10.';
    }
}
